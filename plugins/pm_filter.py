...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('📥 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 📥', url='https://t.me/iPopkarnTutorial')
        ]
    )
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/Mx_Movie_Request'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/Mx_Support_Bot')
        ]
    )
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ IᴘᴏᴘᴋᴀʀɴBᴏᴛs ♥️')
            else:
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check pm i have sent file', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤩 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/MxBackups'),
            ],[
            InlineKeyboardButton('💥 ʜᴏᴡ ᴛᴏ ᴡᴀᴛᴄʜ ᴍᴏᴠɪᴇs ᴏʀ sᴇʀɪᴇs 💥', url='https://t.me/iPopkarnTutorial'),
            ],[
        ...
        await query.answer('Sᴜᴘᴘᴏʀᴛ IᴘᴏᴘᴋᴀʀɴBᴏᴛs')
        ...
        buttons = [[
            InlineKeyboardButton('❤️ ɢʀᴏᴜᴘ ✨', url='https://t.me/Mx_Movie_Request'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Mx_Networks'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴜᴘᴘᴏʀᴛ', url='https://t.me/Mx_Support_Bot'), #Please Change your bot username
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Hᴇʀᴇ ɪs ᴡʜᴀᴛ ɪ ғᴏᴜɴᴅ ғᴏʀ ʏᴏᴜʀ ǫᴜᴀʀʏ {search}"
